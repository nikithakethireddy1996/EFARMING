        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                String location = searchView.getQuery().toString();
                    if (location != null && !location.equals("") && location.equalsIgnoreCase("grapes")) {
                        latlngs.clear();
                        map.clear();
                    ...
                    if (location != null && !location.equals("") && location.equalsIgnoreCase("mangoes")) {
                        latlngs.clear();
                        map.clear();
                        latlngs.add(new LatLng(38.384401, -100.782266));
                        latlngs.add(new LatLng(39.683452, -97.666177));
                    ...
                    if (location != null && !location.equals("") && location.equalsIgnoreCase("oranges")) {
                        latlngs.clear();
                        map.clear();
                        latlngs.add(new LatLng(38.384401, -100.782266));
                        latlngs.add(new LatLng(39.683452, -97.666177));
                    ...
                    if (location != null && !location.equals("") && location.equalsIgnoreCase("bananas")) {
                        latlngs.clear();
                        map.clear();
                        latlngs.add(new LatLng(38.384401, -100.782266));
                        latlngs.add(new LatLng(39.683452, -97.666177));
                    ...
                    if (location != null && !location.equals("") && location.equalsIgnoreCase("apples")) {
                        latlngs.clear();
                        map.clear();
                    ...
                    if (location != null && !location.equals("") && location.equalsIgnoreCase("carrot")) {
                        latlngs.clear();
                        map.clear();
                        latlngs.add(new LatLng(38.384401, -100.782266));
                        latlngs.add(new LatLng(39.683452, -97.666177));
                    ...
                    if (location != null && !location.equals("") && location.equalsIgnoreCase("cucumber")) {
                        latlngs.clear();
                        map.clear();
                        latlngs.add(new LatLng(38.384401, -100.782266));
                        latlngs.add(new LatLng(39.683452, -97.666177));
                    ...
                    if (location != null && !location.equals("") && location.equalsIgnoreCase("spinach")) {
                        latlngs.clear();
                        map.clear();
                        latlngs.add(new LatLng(38.384401, -100.782266));
                        latlngs.add(new LatLng(39.683452, -97.666177));
                    ...
                    if (location != null && !location.equals("") && location.equalsIgnoreCase("capsicum")) {
                        latlngs.clear();
                        map.clear();
                    ...
                    if (location != null && !location.equals("") && location.equalsIgnoreCase("potato")) {
                        latlngs.clear();
                        map.clear();
                        latlngs.add(new LatLng(38.384408, -100.782269));
                        latlngs.add(new LatLng(39.683454, -97.666179));
